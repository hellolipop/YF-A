...
(function () {
  ...
  const VIEWS = {
    ...
    alerts: '预警中心', news: '资讯快讯', advisor: 'AI 选股', scan: '买入扫描', trade: '模拟交易',
  };
  ...
  document.addEventListener('keydown', (e) => {
    ...
    const order = ['market', 'watchlist', 'detail', 'screener', 'scan', 'advisor', 'trade',
      'features', 'backtest', 'tracker', 'system', 'alerts', 'news'];
